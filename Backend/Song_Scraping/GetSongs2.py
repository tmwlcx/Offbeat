...
cur = conn.cursor()
sql = "select artist_uri from artist where artist_id not in (select artist_id from album) ORDER BY artist_uri DESC;"
...
client_credentials_manager = SpotifyClientCredentials(client_id=config2.client_id,
